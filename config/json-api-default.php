...
return [
    ...
    */
    'resources' => [
        ...
        // 'clients' => \App\Post::class,
        // 'websites' => \App\Post::class,
        // 'sites' => \App\Models\_site::class,
        'builder' => \App\Models\_builder::class,
        'builders' => \App\Models\_builder::class,
        'products' => \App\Models\_product::class,
        'categorys' => \App\Models\_category::class,
    ],
